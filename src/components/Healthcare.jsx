      ...
      <div>
        ...
        <section>
          <div id="second-section">
            ...
            <p className="fs-4 text-dark">
              ...
              destination for cutting-edge med-tech solutions in India and
              beyond. Established in June 2017, SurgiSol stands as a beacon of
              excellence, specializing in the distribution of top-tier medical
              devices, instruments, implants, and consumables from renowned
              global manufacturers. At SurgiSol, our core focus extends beyond
              mere distribution. We specialize in fostering partnerships and
              facilitating connections for a diverse range of healthcare
              projects. From liaising on government tenders to overseeing
              turnkey projects and nurturing public-private partnerships,
              SurgiSol thrives on being the conduit for groundbreaking
              healthcare solutions. Join us at SurgiSol Healthcare Solutions Pvt
              Ltd as we continue to redefine healthcare solutions and shape the
              future of the medical landscape, one innovation at a time.
            </p>
          </div>
        </section>
        ...
        <section>
          <div className="mt-5">
            ...
            <p className="text-secondary text-center fs-4">
              ...
              Surgical Precision and Patient Care with Cutting-Edge
              Technologies.
            </p>
          </div>
        </section>
          ...
          <div className="row py-5">
            ...
            <div className="col-md-6">
              ...
              <p className="text-secondary text-center fs-4">
                ...
                surgical tools to enhance the accuracy, efficiency, and safety
                of various surgical interventions. At its core, the Smart SurgN
                ...
                surgeons by providing real-time guidance, predictive insights,
                and personalized recommendations during procedures{" "}
        ...
        <section>
          <div id="diagnosis-section" className="position-relative mt-5">
            <div className="position-absolute top-50 start-0 translate-middle-y">
              <div className="fs-3 px-3 px-md-5 text-dark">
                Let's Try! to Support
              </div>
              <p className="fs-2 px-3 px-md-5 text-dark">
            ...
            <div className="col-md-6 mb-4 mb-md-0">
              <div className="border border-1 border-secondary rounded p-3">
                <div className="py-2 px-4">
                  <div className="fs-2 fw-bold text-center text-white">
                    Contact Us
                  </div>
                  <div className="text-white">
                    Call us Directly : +91 9874563210
                  </div>
                  <div className="text-white">
                    Email us to : surgisol@gmail.com
                  </div>
                </div>
          ...
          <div className="mt-2">
            <div className="d-flex flex-column flex-md-row align-items-center">
              ...
              <div className="px-3 px-md-4 text-center text-md-start">
                ...
                <p>
                  ‘’Profit is not legitimate purpose of business, the legitimate
                  purpose of business is to provide a product or service that
                  people need and do it so well that’s it’s profitable.’’
                </p>
              </div>
            </div>
          </div>
